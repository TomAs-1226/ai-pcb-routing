...
def mounting_holes_corners(
    ...
    """Four M3 mounting holes placed at the corners of the board.

    The holes are inset 4 mm from each edge.
    ...
    positions = {
        "hole_tl": (margin, margin),
        "hole_tr": (board_width - margin, margin),
        "hole_br": (board_width - margin, board_height - margin),
        "hole_bl": (margin, board_height - margin),
    }
